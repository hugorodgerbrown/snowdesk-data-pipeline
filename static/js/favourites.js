...
(function () {
  ...
  // SNOW-814: the region pin control used to be handled here — a delegated
  // click on `[data-region-pin]`, the pill the region summary carried. That
  // pill is gone; pinning is a roundel in the ribbon header now, owned by
  // static/js/map_region_panel.js, which is where the pinned list it reads
  // its state from already lives. Nothing about it was ever a favourites-
  // sheet concern: this module handled it only because the pill arrived
  // inside markup this module was already delegating over.
