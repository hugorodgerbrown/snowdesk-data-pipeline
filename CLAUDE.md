...
| Route anatomy — exploded view of a saved route's layers (track, slope colours, cruxes, no-fall passages, fall-line arrows, trip bulletin join), with screenshots | [`docs/route-anatomy/`](docs/route-anatomy/) |
