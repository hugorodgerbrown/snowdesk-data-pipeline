...
| Why the bank angle is drawn signed (bank.py, bank_angle_deg, bank_angles, `roll_deg`, `banks` on the wire, bank_ribbon_core.js bankWedge / bankWedges, the level-ski wedges; bankGlyphs' max-|roll| segment groups and the zoom-in placeholder; lookup vs pattern, no gate, the flat array) | [`docs/decisions/the-bank-angle-is-drawn-signed.md`](docs/decisions/the-bank-angle-is-drawn-signed.md) |
