...
| Why an area download picks its content by crude rectangle, never real geometry (areaContentPlan, areaBBox, bboxesOverlap; the superset invariant) | [`docs/decisions/inside-the-boundary-is-complete.md`](docs/decisions/inside-the-boundary-is-complete.md) |
