...
class TestSettingsCardLayout:
    ...
    def test_former_text_links_are_buttons(self) -> None:
        ...
        # SNOW-930: Reset was the third of them and is not on this page any
        # more — it moved to /offline/ with the rest of the device block,
        # where tests/public/test_pwa_reset.py asserts it.
    ...
    def test_sign_out_sits_in_the_account_group(self) -> None:
        ...
        # SNOW-930: what "This device" holds now. Theme, because it is a
        # browser-local display preference, and a pointer to /offline/,
        # where the reset and the audit went. The reset itself is on
        # neither group of this page any more.
        assert 'data-testid="settings-offline-link"' in device
