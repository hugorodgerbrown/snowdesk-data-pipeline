"""
tests/bulletins/test_forecast_history_admin.py — ForecastPointWeatherHistoryAdmin.
...
CHANGELIST_URL = reverse("admin:bulletins_forecastpointweatherhistory_changelist")
