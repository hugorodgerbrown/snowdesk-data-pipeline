"""
tests/weather/services/test_weather_fetcher.py — Tests for the weather_fetcher service.
...
class TestBackfillAllRegions:
    ...
    def test_delay_sleeps_between_regions(self) -> None:
        ...
        with (
            ...
            patch("apps.weather.services.weather_fetcher.time.sleep") as mock_sleep,
        ):
...
class TestApiKeyThreading:
    ...
    def test_key_is_never_logged(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        logger_name = "apps.weather.services.weather_fetcher"
...
class TestResolveWeatherSource:
    ...
    def test_local_mirror_raises_when_setting_absent(self) -> None:
        ...
        from apps.weather.services import weather_fetcher
...
class TestFetchWeatherAsync:
    ...
    def test_sync_mode_swallows_inner_exception(
        ...
        monkeypatch.setattr(
            "apps.weather.services.weather_fetcher.fetch_archive_for_region", _boom
        )
    ...
    def test_sync_mode_skips_when_snapshot_already_exists(
        ...
        monkeypatch.setattr(
            "apps.weather.services.weather_fetcher.fetch_weather_for_region", _boom
        )
