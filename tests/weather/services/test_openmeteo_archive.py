"""
tests/weather/services/test_openmeteo_archive.py — Tests for the Open-Meteo NDJSON archive.

Covers the pure functions in ``apps.weather.services.openmeteo_archive``:
...
from apps.weather.services.openmeteo_archive import merge, read_archive, write_archive
