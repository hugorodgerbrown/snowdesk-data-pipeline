"""
tests/weather/services/test_forecast_points.py — Tests for resolve_forecast_point.
...
fetch_elevation is mocked at the apps.weather.services.forecast_points module
