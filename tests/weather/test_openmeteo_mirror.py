"""
tests/weather/test_openmeteo_mirror.py — Tests for the dev-only Open-Meteo mirror view.

The mirror replays ``apps/weather/local_mirrors/openmeteo_archive.ndjson`` in an Open-Meteo-
...
from apps.weather.services.openmeteo_archive import write_archive
