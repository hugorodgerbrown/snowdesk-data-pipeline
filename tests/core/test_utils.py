"""
tests/core/test_utils.py — Tests for core utility functions.
...
class TestHtmlToMarkdown:
    ...
    def test_none_returns_empty(self) -> None:
        ...
        assert html_to_markdown(None) == ""  # type: ignore[arg-type]  # testing None-tolerance
