"""
bulletins/services/grouping.py — Bulletin grouping boundary computation (SNOW-323).
...
The dissolve delegates to ``regions.fixture_utils.boundary_from_children``
...
if TYPE_CHECKING:
    from bulletins.models import Bulletin, BulletinGrouping
