...
| Target day | The day a bulletin *forecasts*, as opposed to the day it was published: a morning issue forecasts today, an evening issue tomorrow | `target_day_for_valid_from()` in `apps/bulletins/services/day_rating.py` |
