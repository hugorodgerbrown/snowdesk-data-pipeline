...
# trips/ (SNOW-819) — same ordering constraint as routes/ above: the public
# catch-all would otherwise resolve "trips" as a region_id.
urlpatterns.append(path("trips/", include("apps.trips.urls")))
