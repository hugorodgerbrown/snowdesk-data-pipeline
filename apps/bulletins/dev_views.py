...
``openmeteo_mirror``
    Replays ``apps/bulletins/local_mirrors/openmeteo_archive.ndjson`` in an
...
from apps.bulletins.services.openmeteo_archive import (
...
def openmeteo_mirror(
    ...
    """
    Replay apps/bulletins/local_mirrors/openmeteo_archive.ndjson in Open-Meteo shape.
