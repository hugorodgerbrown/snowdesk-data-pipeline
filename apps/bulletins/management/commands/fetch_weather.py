"""
apps/bulletins/management/commands/fetch_weather.py — Management command: fetch_weather.
...
``apps/bulletins/local_mirrors/openmeteo_archive.ndjson``. Requires
...
``apps/bulletins/local_mirrors/openmeteo_archive.ndjson`` (deduped by
...
from apps.bulletins.models import Bulletin, ForecastPoint, WeatherSnapshot
from apps.bulletins.services.openmeteo_archive import flush_stash
