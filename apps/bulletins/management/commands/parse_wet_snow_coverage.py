"""
apps/bulletins/management/commands/parse_wet_snow_coverage.py — Diagnostic command.
...
import apps.bulletins.services.prose.en  # noqa: F401 — registers the "en" parser
