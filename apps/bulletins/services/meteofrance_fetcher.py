"""
apps/bulletins/services/meteofrance_fetcher.py — Fetch/persist MeteoFrance bulletins.
...
from apps.bulletins.services.slf_fetcher import UnknownRegionError, upsert_bulletin
