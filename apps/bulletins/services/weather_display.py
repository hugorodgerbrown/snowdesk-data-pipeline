"""
apps/bulletins/services/weather_display.py — Render-time helpers for WeatherSnapshot.
...
if TYPE_CHECKING:
    from apps.bulletins.models import ForecastPointWeather, WeatherSnapshot
...
def is_day(
    ...
    Args:
        weather: The :class:`apps.bulletins.models.WeatherSnapshot` or
            :class:`apps.bulletins.models.ForecastPointWeather` to evaluate.
