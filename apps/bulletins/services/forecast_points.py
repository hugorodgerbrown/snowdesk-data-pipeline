"""
apps/bulletins/services/forecast_points.py — Snapping pins onto shared ForecastPoints.
...
Contains the quantisation helpers and the resolution entry point:
  ...
  resolve_forecast_point(latitude, longitude)
      ...
      ``apps.bulletins.services.elevation.fetch_elevation``, then either reuses
