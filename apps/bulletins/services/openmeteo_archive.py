"""
apps/bulletins/services/openmeteo_archive.py — NDJSON archive of Open-Meteo data.

Reading and writing ``apps/bulletins/local_mirrors/openmeteo_archive.ndjson``:
