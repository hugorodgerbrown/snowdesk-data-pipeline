"""
apps/accounts/checks.py — Django system checks for the accounts app.
...
CHECK_ID_PREFIX = "apps.accounts.push_config"
...
def check_vapid_claim_email(app_configs: Any, **kwargs: Any) -> list[Error]:
    ...
    """
    from apps.accounts.push_config import VAPID_CLAIM_EMAIL
