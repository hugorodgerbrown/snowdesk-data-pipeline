...
shell cache name this module exists for. The substitution raises rather
than passing an unsubstituted body through.

It is the ONLY per-deploy value written into the worker. SNOW-933 added a
