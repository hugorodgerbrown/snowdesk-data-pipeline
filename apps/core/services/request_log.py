"""
apps/core/services/request_log.py — Thin service wrapper for RequestLog capture.

Re-exports the ``capture`` function so views import from
``apps.core.services.request_log`` rather than reaching into the manager directly.
...
def capture(request: "HttpRequest") -> "RequestLog":
    ...
    """
    from apps.core.models import RequestLog as _RequestLog  # noqa: PLC0415
