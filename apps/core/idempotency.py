"""
apps/core/idempotency.py — Idempotency-Key request deduplication (SNOW-371).
...
if TYPE_CHECKING:
    from apps.core.models import IdempotencyRecord as IdempotencyRecordType
...
class IdempotencyMiddleware:
    ...
    def __call__(self, request: HttpRequest) -> HttpResponse:
        ...
        # Deferred import — the model lives in apps.core.models which pulls in
        ...
        # is ready.
        from apps.core.models import IdempotencyRecord  # noqa: PLC0415
    ...
    def _resolve_lost_claim(
        ...
        *,
        ...
        # Deferred import — apps.analytics.signals pulls in the analytics
        # app which shouldn't load at middleware-import time.
        from apps.analytics.signals import emit_server_signal  # noqa: PLC0415
