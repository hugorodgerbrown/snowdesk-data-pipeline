# SNOW-313 — Add RequestLog.subscriber FK to accounts.Subscriber.
#
# core.0001_requestlog created the RequestLog table without this FK to avoid
# a circular dependency (accounts.0001_initial depends on core because
...
class Migration(migrations.Migration):
    """Add RequestLog.subscriber FK after accounts app is initialised."""
