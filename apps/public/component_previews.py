...
_ROUTE_POPUP: dict[str, Any] = {
    ...
    # article says what that depends on. It matches the elapsed time in
    # ``meta`` above — one route seen twice cannot take two lengths of
    # time, and SNOW-830 put that figure on the row as well.
    "caption": _("2,180–3,336 m · 5h20m"),
