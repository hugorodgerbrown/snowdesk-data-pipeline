...
FOUNDATION_CATEGORIES: tuple[FoundationCategory, ...] = (
    ...
    FoundationCategory(
        ...
        tokens=(
            ...
            Token("--color-eaws-low-fg", "Low fg", "#1a0000", None),
            Token("--color-eaws-moderate-fg", "Moderate fg", "#1a0000", None),
            Token("--color-eaws-considerable-fg", "Considerable fg", "#1a0000", None),
            Token("--color-eaws-high-fg", "High fg", "#1a0000", None),
            Token("--color-eaws-very-high-fg", "Very-high fg", "#1a0000", None),
        ),
    ),
    FoundationCategory(
        slug="slope",
