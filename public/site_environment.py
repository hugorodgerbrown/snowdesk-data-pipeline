"""
public/site_environment.py — PWA identity strings per site environment (SNOW-399).
...
- ``public.views.serve_manifest`` — bakes the identity into the
...
- ``public.context_processors.site_environment`` — exposes the same
