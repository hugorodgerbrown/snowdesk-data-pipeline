...
Provides the ``og_locale`` filter which converts a Django ``LANGUAGE_CODE``
string (BCP-47 / RFC 5646 format with hyphens) into the OpenGraph locale
format required by the ``og:locale`` meta property (underscore-separated,
e.g. ``"en_GB"``).
