...
the local SQLite. This command re-emits ``pipeline/fixtures/resorts.json``
...
class Command(BaseCommand):
    """Re-emit pipeline/fixtures/resorts.json from the current DB rows."""

    help = (
        "Dump the Resort table to pipeline/fixtures/resorts.json with natural "
