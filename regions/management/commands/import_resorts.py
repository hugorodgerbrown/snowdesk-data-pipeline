...
in a spreadsheet, exported to ``regions/data/resorts.tsv``. This command
...
class Command(BaseCommand):
    """Reconcile the Resort table against regions/data/resorts.tsv."""

    help = (
        "Reconcile the Resort table against the curated sheet "
        "(regions/data/resorts.tsv): add rows the DB lacks, update rows it "
